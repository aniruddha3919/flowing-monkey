...
export const siteConfig = {
  ...
  founder: {
    ...
    name: "Madhav Halder",
    description: "With over 10 years of experience in unconventional strength training, Madhav specializes in merging ancient Indian physical culture with modern biomechanics.",
    stats: [
