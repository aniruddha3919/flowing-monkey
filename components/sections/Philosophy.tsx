    ...
    <section id="methodology" className="py-24 bg-brand-dark">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <span className="text-brand-orange/80 font-bold tracking-[0.2em] text-xs uppercase mb-4 block">
          ...
          <p className="text-lg md:text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
            {siteConfig.philosophy.descriptionStart} <span className="text-white/80 font-bold">{siteConfig.philosophy.descriptionHighlight}</span>
          </p>
        </div>
          ...
          {siteConfig.philosophy.cards.map((card, i) => (
            ...
            >
              <div className="bg-brand-dark p-3 rounded-2xl">
                {getIconComponent(card.iconName, { className: 'w-6 h-6 text-brand-orange/80' })}
              </div>
